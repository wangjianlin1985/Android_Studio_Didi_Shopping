	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (seller != null) { 
            ...
            if ("sellUserName".equals(tempString)) 
            	...
            	seller.setAddDate(Timestamp.valueOf(valueString));
            else if ("address".equals(tempString)) 
            	seller.setAddress(valueString); 
            else if ("latitude".equals(tempString)) 
            	seller.setLatitude(new Float(valueString).floatValue());
            else if ("longitude".equals(tempString)) 
            	seller.setLongitude(new Float(valueString).floatValue());
        } 
	}

...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.iv_userImage.setImageResource(R.drawable.default_photo);
	  ImageLoadListener userImageLoadListener = new ImageLoadListener(mListView,R.id.iv_userImage);
	  syncImageLoader.loadImage(position,(String)mData.get(position).get("userImage"),userImageLoadListener);  
	  /*返回修改好的view*/
	  return convertView; 
    } 

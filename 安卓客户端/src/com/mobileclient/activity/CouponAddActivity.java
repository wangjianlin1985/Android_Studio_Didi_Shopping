			...
			public void onClick(View v) {
				try {
					...
					if(ET_couponName.getText().toString().equals("")) {
						Toast.makeText(CouponAddActivity.this, "优惠券名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_couponMoney.getText().toString().equals("")) {
						Toast.makeText(CouponAddActivity.this, "金额输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_couponTime.getText().toString().equals("")) {
						Toast.makeText(CouponAddActivity.this, "过期时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传优惠券信息*/
					CouponAddActivity.this.setTitle("正在上传优惠券信息，稍等...");

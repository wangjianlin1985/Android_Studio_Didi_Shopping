...
public class CouponUserListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(CouponUserListActivity.this, CouponUserQueryActivity.class);
				startActivityForResult(intent,ActivityUtils.QUERY_CODE);//此处的requestCode应与下面结果处理函中调用的requestCode一致
			}
		});
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("我的优惠券列表");
		ImageView add_btn = (ImageView) this.findViewById(R.id.add_btn);
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(CouponUserListActivity.this, CouponAddActivity.class);
		...
		queryConditionCoupon.setUserObj(username);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new CouponSimpleAdapter(CouponUserListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(CouponUserListActivity.this, CouponDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑优惠券信息
			...
			Intent intent = new Intent();
			intent.setClass(CouponUserListActivity.this, CouponEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("couponId", couponId);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(CouponUserListActivity.this);

...
public class CouponSellerQueryActivity extends Activity {
	// 声明查询按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.coupon_seller_query);
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					Declare declare = (Declare) CouponSellerQueryActivity.this.getApplication();
					String sellUserName = declare.getUserName();
					queryConditionCoupon.setSellerObj(sellUserName);
					/*获取查询参数*/

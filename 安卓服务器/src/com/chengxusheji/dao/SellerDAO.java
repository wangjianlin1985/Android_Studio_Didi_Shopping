...
public class SellerDAO {
    ...
    public ArrayList<Seller> QuerySellerInfo(String sellUserName,String sellerName,String telephone,String addDate,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	...
    	if(!addDate.equals("")) hql = hql + " and seller.addDate like '%" + addDate + "%'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Seller> QuerySellerInfo(String sellUserName,String sellerName,String telephone,String addDate) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Seller seller where 1=1";
    	if(!sellUserName.equals("")) hql = hql + " and seller.sellUserName like '%" + sellUserName + "%'";
    	if(!sellerName.equals("")) hql = hql + " and seller.sellerName like '%" + sellerName + "%'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String sellUserName,String sellerName,String telephone,String addDate) {
        Session s = factory.getCurrentSession();
        String hql = "From Seller seller where 1=1";
        if(!sellUserName.equals("")) hql = hql + " and seller.sellUserName like '%" + sellUserName + "%'";
        if(!sellerName.equals("")) hql = hql + " and seller.sellerName like '%" + sellerName + "%'";

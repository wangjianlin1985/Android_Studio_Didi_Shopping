...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>登录密码:</td>
    <td width=70%><input id="seller.password" name="seller.password" type="text" size="20" /></td>
  </tr>
  ...
  <tr>
    <td width=30%>入驻日期:</td>
    <td width=70%><input type="text" readonly id="seller.addDate"  name="seller.addDate" onclick="setDay(this);"/></td>
  </tr>
  ...
  <tr>
    <td width=30%>纬度:</td>
    <td width=70%><input id="seller.latitude" name="seller.latitude" type="text" size="8" /></td>
  </tr>

  <tr>
    <td width=30%>经度:</td>
    <td width=70%><input id="seller.longitude" name="seller.longitude" type="text" size="8" /></td>
  </tr>

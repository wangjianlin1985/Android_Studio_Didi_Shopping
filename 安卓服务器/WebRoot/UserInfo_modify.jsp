...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>用户照片:</td>
    <td width=70%><img src="<%=basePath %><%=userInfo.getUserImage() %>" width="200px" border="0px"/><br/>
    <input type=hidden name="userInfo.userImage" value="<%=userInfo.getUserImage() %>" />
    <input id="userImageFile" name="userImageFile" type="file" size="50" /></td>
  </tr>
  <tr>
    <td width=30%>用户qq:</td>
    <td width=70%><input id="userInfo.qq" name="userInfo.qq" type="text" size="20" value='<%=userInfo.getQq() %>'/></td>
  </tr>
